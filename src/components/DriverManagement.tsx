...

      {
        (loading) ? <TableSkeleton /> : (
          <div className="w-full overflow-auto">
            <Paper
              elevation={0}
              sx={{ width: '100%', height: "100%", overflow: 'hidden', backgroundColor: "transparent" }}
            >
                    ...
                    {userData.length === 0 ? (
                      ...
                      userData.map((row) => (
                        <tr key={row.driverId} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                          <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-white">{row.id}</td>
                          <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-white">{row.firstName}</td>
                          <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-white">{row.lastName}</td>
                          <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-white">{row?.gender || '-'}</td>
                          <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-white">{row.phone || '-'}</td>
                          <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700 dark:text-white max-w-xs truncate">{row.address || '-'}</td>
